...
public class AlxGifHelper {
    ...
    /*public static class ProgressViews{
        public ProgressViews(WeakReference<GifImageView> gifImageViewWeakReference, int displayWidth) {
    ...
    *//**
     ...
     * @param gifView
     *//*
    public static void displayImage(final String url, GifImageView gifView, TextView tvProgress, int displayWidth){
        //首先查询一下这个gif是否已被缓存
